    ...
    button: {
      ...
      color: {
        primary: {
          ...
          soft: "bg-light-blue-100 dark:bg-light-blue-dark-100 hover:bg-light-blue-200 dark:hover:bg-light-blue-dark-200 active:bg-light-blue-300 focus-visible:bg-light-blue-300 text-light-blue dark:text-light-blue-dark",
        },
      },
    },
    divider: {
